...
- Complete the external Core PR gates: obtain maintainer review and merge of the Core, documentation, and Brands pull requests. Brands and documentation automated checks are green; the latest Core deterministic check is green and its full CI is running for the parent-removal protection head.
