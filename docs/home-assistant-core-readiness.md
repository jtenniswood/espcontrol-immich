...
- Complete the external Core PR gates: obtain maintainer review and merge of the Core, documentation, and Brands pull requests. Brands, documentation, and Core automated checks are green, including the latest Core full CI run for the cache-isolation head.
