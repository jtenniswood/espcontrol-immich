...
- Complete the external Core PR gates: obtain maintainer review and merge of the Core, documentation, and Brands pull requests. Brands and documentation automated checks are green; Core's deterministic and full CI checks are green for the latest hardening head.
