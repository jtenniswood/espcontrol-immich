...
- Complete the external Core PR gates: obtain maintainer review and merge of the Core, documentation, and Brands pull requests. Brands, documentation, and Core automated checks are green, including full Core CI run `35481601562` for head `21c612f1`.
