...
- Complete the external Core PR gates: obtain maintainer review and merge of Core PRs #182693 and #182737, plus the documentation and Brands pull requests. The base Core PR's full CI is green, and the migration follow-up's deterministic checks plus previous full CI are green; its fresh full matrix is still running. The remaining gates are current validation, maintainer review/merge, and retargeting the stacked migration PR after #182693 merges.
