...
class Storage:
    ...
    def save_frame(self, frame: FrameConfig) -> None:
        data = {"frame_id": frame.frame_id, "name": frame.name, "mode": frame.mode, "pair_window_days": frame.pair_window_days, "pairs_only": frame.pairs_only, "slideshow_interval": frame.slideshow_interval, "filter": frame.filter, "output_width": frame.output_width, "output_height": frame.output_height, "fit": frame.fit}
